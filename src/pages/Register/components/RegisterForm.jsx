  ...
  return (
    <div className="w-full lg:w-1/2 h-screen flex flex-col justify-between px-6 py-6 lg:px-16 lg:py-8 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-[420px]">
        ...
        {/* Botão Google */}
        <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#F4F7FE] rounded-2xl text-[#2B3674] text-sm font-medium hover:bg-[#eef2fc] transition-colors mb-4">
        ...
        <button className="w-full py-3 bg-[#FF5F1F] rounded-2xl text-white text-sm font-bold hover:opacity-90 transition-opacity mb-4">
          Create Account
        </button>
