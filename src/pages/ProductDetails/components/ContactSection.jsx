/**
 * ContactSection - Seção de contato da página de detalhes
 * Exatamente igual ao Figma - não alterar estrutura
 */
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div>
              <p className="text-black font-medium text-sm mb-3">FOLLOW US:</p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#E0E0E0] flex items-center justify-center hover:bg-black hover:text-white transition-colors">
