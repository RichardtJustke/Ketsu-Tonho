  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Eventos agendados por data</p>
      </div>
      <Card>
        <CardHeader>
            ...
            {Array.from({ length: daysInMonth }).map((_, i) => {
              ...
              return (
                <div key={day} className="min-h-[80px] rounded-md border p-1.5">
                  ...
                  {dayOrders.map((o) => (
                    <div key={o.id} className={`mt-1 truncate rounded px-1 py-0.5 text-[10px] ${statusColor[o.status] ?? "bg-primary/15 text-primary"}`}>
