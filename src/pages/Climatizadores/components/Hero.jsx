                ...
                <AnimateIn animation="fade-in-up">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-white/80 text-lg md:text-xl leading-relaxed max-w-2xl">
                            Soluções eficientes e de alta performance para garantir o conforto térmico do seu evento. Oferecemos opções potentes e portáteis, adequadas para ambientes de todos os tamanhos, permitindo que seus convidados aproveitem ao máximo, independentemente do clima.
                        </p>
                    </div>
                </AnimateIn>
            </div>
